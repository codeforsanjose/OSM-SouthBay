...
[Open Source San José](https://www.codeforsanjose.org/) (formerly Code for San José) is a nonprofit community organization that focuses on open-source civic technology. In partnership with OSSJ, OSM’s South Bay mapping community holds a biweekly South Bay Map Night online. Upcoming Map Nights are listed on [OSMCal](https://osmcal.org/?in=United%20States) and cross-posted to [Mastodon](https://sfba.social/@opensourcesanjose), [Bluesky](https://bsky.app/profile/opensourcesanjose.bsky.social), and [Meetup](https://www.meetup.com/bay-area-openstreetmappers/). You can also find out OSSJ’s general in-person meetings on [Eventbrite](https://www.opensourcesanjose.eventbrite.com/).

To get in touch with other South Bay mappers and civic tech volunteers, invite yourself to the [Open Source San José Slack](https://join.slack.com/t/opensourcesanjose/shared_invite/zt-1yt8dkv1y-Pn47~dt9of8nNHa2U9kioA) workspace and join the [#proj-osm](https://opensourcesanjose.slack.com/archives/C69JM3UDD) channel, or join the [Open Source San José Discord](https://discord.gg/3bAd9DAWCp) server and join the [#🗺️openstreetmap](https://discord.com/channels/1086028270455230625/1086348869329227877) channel. If you have a cool idea for something local mappers could add to OpenStreetMap, please [open a new issue](https://github.com/codeforsanjose/OSM-SouthBay/issues/new/).
